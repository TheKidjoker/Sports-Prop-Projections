...
export const SPORTS: SportConfig[] = [
  { id: "NHL", label: "NHL", subtitle: "Gotham Ice", confidence: "validated", confidenceLabel: "Validated Model", gamesCount: 8 },
  { id: "NBA", label: "NBA", subtitle: "Gotham Court", confidence: "experimental", confidenceLabel: "Experimental", gamesCount: 12 },
  ...
  { id: "CBB", label: "CBB", subtitle: "Gotham Hardwood", confidence: "experimental", confidenceLabel: "Experimental", gamesCount: 6 },
];
