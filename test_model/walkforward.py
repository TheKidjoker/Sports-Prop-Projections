...
def run_walkforward(sport, mode="split"):
    ...
    tm_db.save_model_run({
        ...
        "model_params": {
            ...
            "confidence_intervals": aggregated.get("confidence_intervals", {}),
            "comparison": comparison,
            "fold_details": aggregated.get("fold_details", []),
            "total_qualified": aggregated.get("total_qualified", 0),
            "total_strong": aggregated.get("total_strong", 0),
            "mean_qualified_accuracy": aggregated.get("mean_qualified_accuracy"),
            "mean_qualified_roi": aggregated.get("mean_qualified_roi"),
            "mean_strong_accuracy": aggregated.get("mean_strong_accuracy"),
            "mean_strong_roi": aggregated.get("mean_strong_roi"),
            "std_accuracy": aggregated.get("std_accuracy"),
            "std_roi": aggregated.get("std_roi"),
        },
